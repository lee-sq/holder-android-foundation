...
public class UVCCamera {
	...
	public static int DEFAULT_ROTATION = 0;
	public static int DEFAULT_BITRATE = 1024 * 1024;
	public static int DEFAULT_PREVIEW_WIDTH = 1920;
	public static int DEFAULT_PREVIEW_HEIGHT = 1080;
	public static int DEFAULT_PREVIEW_MIN_FPS = 1;
	public static int DEFAULT_PREVIEW_MAX_FPS = 31;
	public static float DEFAULT_BANDWIDTH = 1.0f;
